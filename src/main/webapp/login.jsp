                ...
                <div class="container" style="text-align:center;">
                    <div class="navbar-collapse collapse" style=" width:80%;  position: relative; left: 10%;">
                        <div class="jumbotron" style="margin:5%;padding:1% 20%;">
                            ...
                            <form action="login" id="login-form" class="diy-form" style="text-align: left;" method="post" onsubmit="return validate();">

                                <div class="form-group">
                                    <label for="tele" style="text-align: left;">ID<font class="font" style="color: red;zoom:95%;font-weight:500;display:none;"> &nbsp;* 手机号不能为空 ！ </font></label>
                                    <input id="tele" type="text" class="form-control" placeholder="请输入手机号" />
                                </div>
